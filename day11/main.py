        ...
        if enemy["hp"] <= 0:
            ...
            if enemy["name"] == "Волк":
                if random.randint(1, 100) <= 50:
                    player["inventory"].append("Клык волка")
                    print("Получен предмет: Клык волка!")
...
def shop():
    ...
    3. Продать Клык волка - 10 золота
    4. Выход
    """)
        choice = input("Выбор: ")
        ...
        if choice == "1":
            ...
            if "Клык волка" in player["inventory"]:
                player["inventory"].remove("Клык волка")
                player["gold"] += 10
                save_player()
                
                print("Клык волка продан!")
            else:
                print("У тебя нет Клыка волка!")
